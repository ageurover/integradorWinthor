        ...
        new Thread() {//instancia nova thread jï¿½ implementando o mï¿½todo run()
            ...
            public void run() {//sobrescreve o mï¿½todo run()
                try {
                    ...
                    MessageDialog.info("Exportacao finalizada!");
                    ...
                    for (int d = 0; d < tblDataHeader.getRowCount(); d++) {
                        ...
                        for (int i = 0; i < tblHeader.getRowCount(); i++) {
                            ...
                            if ((!tipoDado.equalsIgnoreCase("NLN")) && (campo.length() != tamanho)) {
                                MessageDialog.error("Tamanho do campo nao confere com o layout "
...
//        dispose();
    ...
    private void btnLayoutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLayoutActionPerformed
        LayoutRemessaDialog.open(Formato.strToInt(edtCodDoc.getText()), edtTipoDoc.getText());
        exibeSqlComando();
