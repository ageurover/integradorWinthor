...
public class ExportDocDialog extends javax.swing.JDialog {
        ...
        new Thread() {//instancia nova thread j� implementando o m�todo run()
            ...
            public void run() {//sobrescreve o m�todo run()
                try {
                    ...
                    MessageDialog.info("Exporta��o finalizada!");
                    ...
                    for (int d = 0; d < tblDataHeader.getRowCount(); d++) {
                        ...
                        for (int i = 0; i < tblHeader.getRowCount(); i++) {
                            ...
                            if ((!tipoDado.equalsIgnoreCase("NLN")) && (campo.length() != tamanho)) {
                                MessageDialog.error("Tamanho do campo n�o confere com o layout "
    ...
    /*
     Gera um arquivo CSV com os campos de cabe�alho e os dados separados por 
     ponto e virgula, para poder usar o execel para verificar se as posi�oes 
